...
export default function ARLayout({ children }: { children: React.ReactNode }) {
  ...
  const isARRoute =
    router.pathname.startsWith("/augmented-reality/ar/") ||
    router.pathname === "/augmented-reality/ar" ||
    router.pathname.startsWith("/augmented-reality/qr/") ||
    router.pathname === "/augmented-reality/qr";
  ...
  useEffect(() => {
    ...
    const isLeavingARRoute =
      previousRoute &&
      (previousRoute.includes("/augmented-reality/ar") ||
        previousRoute.includes("/augmented-reality/qr/"));

    const isEnteringARRoute =
      currentRoute &&
      (currentRoute.includes("/augmented-reality/ar") ||
        currentRoute.includes("/augmented-reality/qr/"));
  ...
  useEffect(() => {
    const handleRouteChange = (url: string) => {
      ...
      if (
        isLeavingARRoute &&
        !url.includes("/augmented-reality/ar") &&
        !url.includes("/augmented-reality/qr/")
      ) {
        console.log(
