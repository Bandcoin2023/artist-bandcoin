            ...
            <div className="flex gap-4 h-[calc(100vh-10.8vh)] overflow-hidden">
                {selectedMode === Mode.User ? (
                    <>
                        ...
                        >
                            <div className="flex flex-col w-full h-[calc(100vh-10.8vh)]">{children}</div>
                        </motion.div>
                        <AnimatePresence>
                            <motion.div
                                className={cn(
                                    "fixed z-40 right-[13.3rem] top-1/2 hidden rotate-180 rounded-sm md:block",
                                    isMinimized && "-rotate-180 right-[.5rem]",
                                )}
                                initial={false}
                        ...
                        <div className="hidden h-[calc(100vh-23vh)] md:block bg-background border-[1px] rounded-sm">
                            <motion.div
                                className="h-full sticky top-0 p-1 overflow-y-auto hidden md:block"
                                initial={false}
                                animate={isMinimized ? "collapsed" : "expanded"}
                                                ...
                                                creators.items.map((creator) => (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <motion.div className="flex flex-col items-start justify-center" variants={itemVariants}>
                                                ...
                                                >
                                                    {creators.isFetchingNextPage ? (
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <SkeletonEffect className="w-4 h-4 rounded-full" />
                                                        </div>
                                                    ) : (
                                                        "Load More"
                                                    )}
