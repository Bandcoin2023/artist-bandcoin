...
export const Icons = {
  ...
  lastfm: ({ ...props }: LucideProps) => (
    <svg fill="#000000" version="1.1" xmlns="http://www.w3.org/2000/svg" width="800px"
      height="800px" viewBox="0 0 512 512" >

      <g id="7935ec95c421cee6d86eb22ecd125006">

        <path className="display: inline;" d="M308.214,337.861l-5.663-13.064L253.93,209.107c-16.056-40.931-56.085-68.601-101.198-68.601
