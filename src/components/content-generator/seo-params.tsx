...
import { Target, Settings2, Zap } from "lucide-react"
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Select value={params.contentStructure} onValueChange={(v) => onParamsChange({ contentStructure: v })}>
                <SelectTrigger className="h-9 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-1.5">
            <Label className="text-xs text-muted-foreground">Word Count: {params.wordCount[0]?.toLocaleString()}</Label>
            <Slider
