...
import { Share2, Settings2, Zap, Twitter, Linkedin, Instagram, Facebook } from "lucide-react"
          ...
          {(["twitter", "linkedin", "instagram", "facebook"] as Platform[]).map((platform) => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center gap-1.5 p-3 rounded-xl border-2 transition-all ${params.selectedPlatform === platform
                  ? "bg-accent"
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <Select value={params.targetDemographic} onValueChange={(v) => onParamsChange({ targetDemographic: v })}>
                <SelectTrigger className="h-9 text-sm">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
