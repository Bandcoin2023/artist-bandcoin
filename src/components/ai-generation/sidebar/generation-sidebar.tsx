...
import { RotateCcw, Lock, ChevronDown, ArrowLeft } from "lucide-react"
...
export function GenerationSidebar() {
  ...
  return (
    <aside className="w-full md:w-96 h-[calc(100vh-10.8vh)] bg-card border-r border-border flex flex-col  overflow-hidden ">
