                    ...
                    <DialogHeader className="px-2 py-4 md:px-4">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <DialogTitle className="text-xl font-bold">Create Location Bounty</DialogTitle>
                            </div>
                        </div>
            ...
            <Card className="border-0 shadow-sm bg-gradient-to-br from-accent/20 to-accent/20">
                <CardHeader className="pb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h3 className="font-semibold">Bounty Rewards</h3>
                    ...
                    <Card className="bg-amber-50 border-amber-200">
                        <CardContent className="p-4">
                            <div className="flex items-start gap-2 text-amber-800">
                                ...
                                <p className="text-sm">
                                    Enter the exact coordinates where users need to be to claim this bounty. The proximity radius
    ...
    return (
        ...
        >
            ...
            <Card className="border-gray-200 bg-gray-50">
                <CardContent className="p-4">
                    <h4 className="mb-2 text-sm font-medium text-gray-700">Tips for great bounty images:</h4>
...
function SettingsStep() {
    ...
    return (
        ...
        >
            <div className="space-y-1">
                <h2 className="text-xl font-semibold">Bounty Settings</h2>
                    ...
                    <Card className="border-amber-200 bg-amber-50">
                        <CardContent className="flex items-center gap-2 p-3">
                            ...
                            <p className="text-sm text-amber-800">
                                Your bounty is ready to be created. Choose to pay now or pay later.
                            </p>
                        </CardContent>
                    </Card>
                </CardContent>
