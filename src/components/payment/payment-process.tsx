                    ...
                    <div className="grid gap-4 ">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-gray-500">
                                Complete your purchase for <span className=" font-bold   ">
                                    {item.name}
                                </span>
                            </p>
                        </div>
                        <div className="grid gap-2  bg-secondary rounded-md p-4">
    ...
    function Option({
        ...
        return (
            <Button
                ...
                className={clsx("flex w-full items-center justify-center shadow-sm shadow-black ")}
            >
                {text}
            </Button>
        );
            ...
            return (
                <div className="space-y-4">
                    ...
                    {isSufficientAssetBalance ? (
                        ...
                        <Card className="">
                            <CardContent className="p-4 gap-2 flex items-center flex-col w-full">
                                <p>
                                    Your balance: <Badge className="p-2 rounded-sm" variant='destructive'>{platformAssetBalance} {PLATFORM_ASSET.code}</Badge>
                                </p>
