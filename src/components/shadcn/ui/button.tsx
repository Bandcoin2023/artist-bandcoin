  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glassmorphic:
          "bg-background/10 backdrop-blur-md border border-border/20 text-foreground hover:bg-background/20",
        gradient: "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:from-accent hover:to-primary",

        adaptive:
          "dark:bg-accent dark:text-accent-foreground dark:hover:bg-accent/80 bg-primary text-primary-foreground hover:bg-primary/80",
        adaptiveOutline:
          "dark:border-2 dark:border-accent dark:text-accent dark:hover:bg-accent dark:hover:text-accent-foreground border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground",
      },
      ...
      size: {
        ...
        xl: "h-12 rounded-md px-10 text-base", // Added xl size
        icon: "h-10 w-10",
        creator: "h-14 px-6", // Added creator size
      },
    },
    defaultVariants: {
      variant: "default",
