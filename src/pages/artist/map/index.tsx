...
import { ClipboardList, MapPin, Search, X, Plus, Minus, ArrowRightFromLine, ArrowLeftFromLine } from "lucide-react"
    ...
    return (
        <CreatorLayout>
            <APIProvider apiKey={process.env.NEXT_PUBLIC_GOOGLE_MAP_API_KEY!}>
                ...
                <div className="absolute bottom-24 md:bottom-28 right-2 z-10 flex flex-col gap-2">
                    <ReportCollection />
                </div>
            </APIProvider>
        </CreatorLayout>
