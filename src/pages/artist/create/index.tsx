                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
                    ...
                    <div className="w-full lg:w-1/4 lg:sticky lg:top-8 space-y-6">
                            ...
                            {Array.from({ length: totalSteps }).map((_, index) => (
                                <motion.div
                                    ...
                                    className={cn(
                                        ...
                                        currentStep === index + 1
                                            ? "bg-primary border-foregound border-2"
                                            : currentStep > index + 1
                                                ? "bg-primary"
                                                : "bg-background",
                                    )}
                                >
                                    ...
                                    {currentStep === index + 1 && <ChevronRight className="ml-auto h-5 w-5 " />}
                                </motion.div>
                            ))}
                        </div>
                        ...
                        <div className="hidden lg:block p-4 rounded-lg bg-muted/50 border border-border">
                            ...
                            <Button variant="accent" className="text-xs p-0 h-auto mt-2">
                                Contact Support
                            </Button>
                        </div>
                    </div>
                                                ...
                                                <div className="space-y-6">
                                                        ...
                                                        {[
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex flex-col gap-3">
                                                                    <div className="rounded-full bg-primary0 p-3 w-fit ">
                                                                        {benefit.icon}
                                                                    </div>
                                                                    <div>
                                                    ...
                                                    <div className="bg-muted/30 rounded-lg p-4 border border-border">
                                                        <div className="flex items-start gap-3">
                                                            <div className="rounded-full bg-primary p-2 mt-1">
                                                        ...
                                                        <TabsContent value="profile" className="mt-0">
                                                            <div className="flex flex-col md:flex-row gap-8 items-center">
                                                                <div className="w-full md:w-1/2 flex flex-col items-center justify-center space-y-4">
                                                                    {formData.profileUrlPreview ? (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                <User className="h-20 w-20 text-muted-foreground group-hover: transition-colors duration-300" />
                                                                            </motion.div>
                                                                ...
                                                                <div className="w-full md:w-1/2 space-y-4">
                                                                    ...
                                                                    <div className="rounded-lg bg-primary p-4 border border-primary">
                                                                        <div className="flex items-start gap-3">
                                                                            <div className="rounded-full bg-primary p-2 mt-1">
                                                                                <Sparkles className="h-4 w-4 " />
                                                                            </div>
                                                                ...
                                                                <div className="w-full md:w-1/2 flex flex-col items-center justify-center space-y-4">
                                                                    {formData.coverImagePreview ? (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            >
                                                                                <PanelTop className="h-20 w-20 text-muted-foreground group-hover: transition-colors duration-300" />
                                                                            </motion.div>
                                                                            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-background/80 backdrop-blur-sm px-4 py-1 rounded-full text-sm font-medium text-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                ...
                                                <div className="space-y-6">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex flex-col gap-3">
                                                                <div className="rounded-full bg-primary p-3 w-fit ">
                                                                    ...
                                                                    <div className="w-full md:w-1/2">
                                                                        ...
                                                                        <div className="flex flex-col gap-4">
                                                                            {formData.assetImagePreview ? (
                                                                                ...
                                                                                >
                                                                                    <ImageIcon className="h-16 w-16 text-muted-foreground group-hover: transition-colors duration-300" />
                                                                                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-background/80 backdrop-blur-sm px-4 py-1 rounded-full text-sm font-medium text-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                                                        Click to upload
                                                                                    </div>
                                                                                </motion.div>
                                        ...
                                        {currentStep === 5 && (
                                            <div className="p-6 md:p-8">
                                                <div className="space-y-6">
                                                    ...
                                                    <div className="rounded-lg bg-primary p-6 border border-primary">
                                                        <div className="flex items-start gap-3">
                                                            <div className="rounded-full bg-primary p-2 mt-1">
                                                    ...
                                                    <div className="rounded-lg bg-gradient-to-r from-primary to-primary p-6 border border-primary">
                                                        ...
                                                        >
                                                            ...
                                                            <div className="p-3 bg-muted/50 rounded-md">
                                                                <p className="font-mono text-sm">
                                                                    bandcoin.io/
                                                                    <span className="font-bold ">{formData.vanityUrl || "your-name"}</span>
                                                                </p>
                                                            </div>
