  ...
  const steps = [
    {
      ...
      title: "Follow Mode",
      content: "In Follow Mode, see pins for followed artists only. Switch to General Mode to view all artist pins.",
    },
    {
      target: buttonLayouts[1],
      title: "Search for Artists",
      content: "Use the search bar to look for any artist on the platform by typing in the artist name in the search bar, then pressing the search icon",
    },
    {
      target: buttonLayouts[2],
      title: "Artist Lists",
      content: "Click on 'Available Artists' to view all artists, or 'Followed Artists' to see the ones you've followed.",
    },
    {
      target: buttonLayouts[3],
      title: "Follow Artists",
      content: "To follow an Artist, press the follow button next to the artist name. To unfollow an artist, press the unfollow button next to the artist name.",
    },
  ]
            ...
            >
              {filteredBrands?.length ? (
                ...
                <div className="col-span-2 text-center py-12">
                  ...
                  <h3 className="font-medium mb-2 text-slate-900 dark:text-white">No Artists found</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    {searchQuery ? "Try adjusting your search terms" : "No artists available at the moment"}
                  </p>
                </div>
              )}
            </motion.div>
