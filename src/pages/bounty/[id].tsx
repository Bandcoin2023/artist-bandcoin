                                        ...
                                        <TabsList className="bg-transparent p-0 h-auto space-x-6">
                                            {[
                                                ...
                                                <TabsTrigger
                                                    ...
                                                    className="relative py-3 px-2 bg-transparent rounded-none data-[state=active]: data-[state=active]:shadow-none data-[state=active]:bg-transparent"
                                                >
                                                    <div className="flex items-center gap-2">
                                                        <tab.icon size={18} />
                                                        <span>{tab.label}</span>
                                    ...
                                    <TabsList className="bg-transparent p-0 h-auto space-x-6">
                                        {[
                                            ...
                                            <TabsTrigger
                                                key={tab.id}
                                                value={tab.id}
                                                className="relative py-3 px-2 bg-transparent rounded-none data-[state=active]: data-[state=active]:shadow-none data-[state=active]:bg-transparent group"
                                            >
                                                <div className="flex items-center gap-2">
                                                    <tab.icon size={18} />
                                                    <span>{tab.label}</span>
...
function ShowMore({ content }: { content: string }) {
    ...
    return (
        <div className="w-full">
            ...
            <button
                className="mt-2  hover:/80 text-sm font-medium flex items-center"
